...
class printers_mjhs_imaclabcolor {
	...
	exec { "mjhs_imaclab_color":
		command => "/usr/sbin/lpadmin -p psm_MJHS_Lab_Color -L MJHS\\ Computer\\ Lab -D MJHS\\ Lab\\ Color\\ Printer -v lpd://10.13.2.7/iMac_Lab_Color_Printing -P /Library/Printers/PPDs/Contents/Resources/HP\\ Color\\ LaserJet\\ CP3505.gz -E -o printer-is-shared=false",
