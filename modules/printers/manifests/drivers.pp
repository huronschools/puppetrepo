class printers::drivers {
	...
	case $operatingsystem {
		"centos": { 
			...
			$hp_lj4200_driver 	= "hp_LaserJet_4200_Series.ppd.gz"
			$hp_lj9040_source 	= "puppet:///modules/printers/drivers/$operatingsystem/$hp_lj9040_driver"
			$hp_lj9050_source 	= "puppet:///modules/printers/drivers/$operatingsystem/$hp_lj9050_driver"
			$hp_lj4250_source 	= "puppet:///modules/printers/drivers/$operatingsystem/$hp_lj4250_driver"
			$hp_lj4100_source 	= "puppet:///modules/printers/drivers/$operatingsystem/$hp_lj4100_driver"
			$hp_lj8050_source 	= "puppet:///modules/printers/drivers/$operatingsystem/$hp_lj8050_driver"
			$hp_ljcp3505_source	= "puppet:///modules/printers/drivers/$operatingsystem/$hp_ljcp3505_driver"
			$hp_lj4200_source 	= "puppet:///modules/printers/drivers/$operatingsystem/$hp_lj4200_driver"
			...
			$hp_lj4200_path 	= "${printers::params::ppd_path}/HP/mono_laser/$hp_lj4200_driver"
        }			
		"darwin": { 
			...
			$hp_lj4200_driver	= "hp LaserJet 4200 Series.gz"
			$hp_lj9040_source 	= "puppet:///modules/printers/drivers/$macosx_productversion_major/$hp_lj9040_driver"
			$hp_lj9050_source 	= "puppet:///modules/printers/drivers/$macosx_productversion_major/$hp_lj9050_driver"
			$hp_lj4250_source 	= "puppet:///modules/printers/drivers/$macosx_productversion_major/$hp_lj4250_driver"
			$hp_lj4100_source 	= "puppet:///modules/printers/drivers/$macosx_productversion_major/$hp_lj4100_driver"
			$hp_lj8050_source 	= "puppet:///modules/printers/drivers/$macosx_productversion_major/$hp_lj8050_driver"
			$hp_ljcp3505_source	= "puppet:///modules/printers/drivers/$macosx_productversion_major/$hp_ljcp3505_driver"
			$hp_lj4200_source 	= "puppet:///modules/printers/drivers/$macosx_productversion_major/$hp_lj4200_driver"
			...
			$hp_lj4200_path 	= "${printers::params::ppd_path}/$hp_lj4200_driver"
	    }
	}
	...
	file { "HP Laserjet 4200 Driver":
		name		=> "$hp_lj4200_path",
		source		=> "$hp_lj4200_source",
		ensure 		=> present,
		mode		=> 664,
		owner		=> "${printers::params::print_owner}",
		group 		=> "${printers::params::print_group}",
